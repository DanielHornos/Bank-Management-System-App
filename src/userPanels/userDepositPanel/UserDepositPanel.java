package userPanels.userDepositPanel;
		...
		try {			
			...
			buildData(rs);
				...
				if(exc.getMessage().equals("The statement did not return a result set.")) {
					...
					alert.setTitle("Confirmed Deposit");
					alert.setHeaderText(null);
					alert.setContentText("The deposit was done successfully!" + System.lineSeparator() + "The new balance is: " + newBalance.toString());
					alert.showAndWait();
				}
			}
